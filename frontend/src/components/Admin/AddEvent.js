...
class AddEvent extends Component {
    ...
    render() {
        const { title,time,place,ticket,description,short_description,thumbnail,status } = this.state;  
        return (
            <div>
                <div className="">
                    <div className="row">
    ...
    handleSubmit = (e) => {
        e.preventDefault();  
        const { eventId, title, time, place, ticket, description, short_description,thumbnail,status } = this.state;
        const url = !eventId
