    ...
    render() {
        return (
            <div>
                ...
                <div className = "item_categories events " > Events                   
                    <div className="optionsEvent">
                        <ul>
                            <li style={{padding: 8 }}><a href = "/admin/event" style={{color: "black" ,textDecoration: "none"}}>Add Event</a></li>
                            <li style={{padding: 8 }}><a href = "/admin/updateevent"  style={{color: "black" ,textDecoration: "none"}}>Update Event</a></li>
